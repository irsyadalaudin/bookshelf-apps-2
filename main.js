...
document.addEventListener(RENDER_EVENT, function () {
  // console.log(books);
  const incompleteReadBOOKList = document.getElementById(
    "incompleteBookshelfList"
  );
  incompleteReadBOOKList.innerHTML = "";

  const completedReadBOOKList = document.getElementById(
...
function makeBook(bookObject) {
  ...
  if (bookObject.isCompleted) {
    // UNTUK COMPLETE (YANG SUDAH DIBACA)
    ...
    // UNTUK INCOMPLETE (YANG BELUM DIBACA)
